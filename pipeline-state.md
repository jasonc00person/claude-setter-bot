...
**Last updated:** March 7, 2026 (ManyChat session 28 - checkpoint 4 FINAL)
...
| musicbyplv | musicbyplv | IG (Notifications) | 5 - Bridge sent | Awaiting reply. FLAGGED: called out Dan Martell framework |
...
| Giancarlo Kerg | giancarlokerg | IG (ManyChat) | 5 - Calendly sent | Math teacher, had $50K/mo dating funnel YT channel (nuked it). Wants faceless + automated relaunch behind paywall. Has community. Built custom GPT. Qualified all 3 Qs. Agreed to call, Calendly sent Mar 7. Tag: In Conversation |
| Abdulwahab8 | abdulwahab_8_ | IG (ManyChat) | 5 - Calendly sent | Agency owner, 14.2K. Want to hit 30K. Challenge: converting leads, no systems. Tried cold DM + ads. Fully qualified. Calendly sent Mar 7. Said "Sure" (will book). Tag: In Conversation |
| Edmund \| AI | whatelz.ai | IG (ManyChat) | 5 - Bridge sent | AI Engineer, in school, hackathons. First week posting (9 posts). Browses explore/reels, learns from friends' profiles, no courses. Validated + bridge sent Mar 7. Tag: In Conversation |
...
| Lead | Handle | Platform | Stage | Notes |
|-|-|-|-|-|
| Koby Luedtke | [@koby-luedtke-6439](https://www.skool.com/@koby-luedtke-6439) | Skool (CA) | 4 - Q1 sent | $40K MRR full-service agency, Chicago, 70% loan officers. Burned out, too involved, wants to niche down. Not using social consistently. New podcast studio. Permission granted ("Sure"). Q1 sent Mar 7 |
...
| Mikhail Nadeson | -- | Skool (CA) | 3 - Permission sent | Mindset coach, IG + YT. Johannesburg. 20-40k GBP/mo |
| Austin Coldiron | @austincoldiron | Skool (CA) | 4 - Q1 sent | Helping AI coaches scale, $15-20k/mo. Bali |
| Kaden Green | -- | Skool (CA) | 4 - Q3 sent | Section 8 real estate. 45K rev, LA |
| Dane J | @dane-oconnor-3222 | Skool (CA) | 4 - Q3 sent | Founder @Ailaunch, 75K+ Followers, Chicago. Affiliate marketing, coaching offer. Q3 sent |
| Anet Pavelkova | anet_pavelkova | IG (ManyChat) | 4 - Q1 sent | Czech (Europe). Social media pro |
| Chachil | fuente__ovejuna | IG (ManyChat) | 3 - Permission sent | Positive AV ("wanna scale") |
| Nick Puru | nicholas.puru | IG (ManyChat) | 3 - Permission sent | 13K IG + 60K YT. AI automation. Positive AV |
| Joey Mulcahy | byjoeym | IG (ManyChat) | 3 - Permission sent | AI creative workflows for brands |
| Lorien Dean | theloriendean | IG (ManyChat) | 3 - Permission sent | AI content creation educator |
| Dev \| Content Marketing | dev.gotmoney | IG (ManyChat) | 4 - Q3 sent | High ticket DFY, all from IG. Goal: 100k/mo + 100k followers. Q2: systems, direction, client fulfillment. Q3 sent Mar 7 |
| keyko | keykoclipper | IG (ManyChat) | 4 - Q2 sent | Clipping mentorship, 500M views, 40 students |
| Tyler Casey | tylercaseyprod | IG (ManyChat) | 4 - Q2 sent | 23.6K, digital products. Detected AI, owned it |
| Kyle Turton | kyleeturton | IG (ManyChat) | 3 - Permission sent | Media company owner. AV positive |
| Sacha | sachablt_ | IG (Primary) | 3 - Permission sent | Video editor (geo unverified) |
| Blake Loughrey | blake.abl3 | IG (ManyChat) | 4 - Q2 sent | AI Automations. Q1: establish base, GHL automations, content pivot |
...
| Samson | bolu_visuals1 | IG (ManyChat) | 4 - Q2 sent | Video Editor & Strategist. Q1: high paying clients. Q2 sent Mar 7 |
...
| Alkin Cakiralar | alkincakiralar | IG (ManyChat) | 4 - Q2 sent | App for women (plastic surgery visualization), running ads in Turkey only. Q1: scaling ads step by step. Q2 sent Mar 7. Tag: In Conversation |
...
| _aryanxcreates | _aryanxcreates | IG (ManyChat) | 4 - Q3 sent | Tech/SaaS, DevSphere India (likely India geo). Building SaaS tool for devs, wants real users not just followers. Q2: doesn't know what content to create, can't do heavy editing. Q3 sent Mar 7 |
| Valentijn Wiering | valentijnwiering | IG (ManyChat) | 4 - Q1 sent | Beginning to learn IG monetization. Permission granted ("No it would be great"). Q1 sent Mar 7 |
...
| AJ | ajax_pixels | IG (General) | BGM Library |
| Nadav Ben Ezra | nadav.benezra | IG (General) | BGM Library |
| jeet gajjar | jeetgajjar910 | IG (General) | BGM Library |
| Himanshu Choudhary | himanshuu_choudharyy | IG (General) | BGM Library |
| Ⱪdz | nabilt.dz | IG (ManyChat) | BGM Library |
| Dev | __.dev._ | IG (ManyChat) | BGM Library |
| Danele Louw | danelelouwofficial | IG (General) | BGM Library |
| shubham | shubhammjhaa | IG (ManyChat) | Clips interest |
| Samson | bolu_visuals1 | IG (ManyChat) | BGM Library |
| Bh_shootz | briannhogee | IG (ManyChat) | BGM Library |
| Ilona Bernotaite | ilona_ontheroad | IG (ManyChat) | Late software. Female |
| Dr Azmain | doctorazmain | IG (Notifications) | 296K verified |
| ROHAN | rohan_damodar_999 | IG (ManyChat) | Shared reel |
| Tomer Visuals | tomervisuals | IG (ManyChat) | BGM Library |
| Eric Muller | ericxmueller | IG (ManyChat) | Video Editor |
| the_wanderer | the_wanderer.project | IG (ManyChat) | BGM Library |
| Yassine Mimouni | yassine.mimouni__ | IG (ManyChat) | Music creator |
| Miguel Monteiro | miguellcmonteiro | IG (ManyChat) | Videographer |
| Aravind Kamath | ar_kamath | IG (ManyChat) | BGM Library |
| Ferhat | ferhat.invests | IG (ManyChat) | Crypto Mentor |
| Ivan Panov | ivanpanov_11 | IG (ManyChat) | BGM Library |
| Gabriel Bostanică | gabrielbostanica | IG (ManyChat) | BGM Library |
...
| razutoski | razutoski | IG (ManyChat) | YT keyword. Wants BGM Library (owes link). AV sent |
| Brian Skorb | mochisgarage | IG (ManyChat) | BGM Library. AV sent |
| Malcolm Mensah | malcolmmensah63 | IG (ManyChat) | About to start posting. AV sent |
| souryaredraftz | souryaredraftz | IG (ManyChat) | BGM Library. AV sent |
| Igor Radek | iphone_igor | IG (ManyChat) | Late software. AV sent |
| hraika | hraika4 | IG (ManyChat) | BGM Library. Button broken, owes link. AV sent |
| Bojan Obradovic | obojan.ai | IG (ManyChat) | Skool keyword. One Day Film System delivered. AV sent |
| Tyler Germain | itstylergermain | IG (ManyChat) | Music keyword. Got BGM Library. AV sent |
| Graphic Designer Shivam | theaiguy.shivam | IG (ManyChat) | Music keyword. Got BGM Library. AV sent |
...
| Vicetoc | vicetoc | IG (ManyChat) | Designer. BGM Library delivered. AV positive ("love that bro roster designs are sick"). Permission sent Mar 7. **Moved to Qualifying Stage 3** |
...
| devbymighty | devbymighty | IG (ManyChat) | BGM Library manually sent (button broken). AV sent Mar 7 |
| Danilo Banaga | cinemadanny | IG (ManyChat) | Filmmaker. Claude Skills delivered. Asked "Is this an automation?" — humanized response. AV sent Mar 7 |
...
| Lewis | lewis.hindle1 | IG (ManyChat) | Advertising/Marketing, 24, @summitais (backend systems for founders). 676 followers. UK. Replied about his biz. Validated + AV sent Mar 7. Stage 2 |
...
| Deejay Virat | -- | Skool (CA) | 21yo, 4-fig freelance video editing. India |
...
### Primary Inbox
Daniel BR (dbr.live), Max Jones (m0xjon3s), Toby J (toby.ai.guy), Brian Glusovich (bglusovich_fit), Sol Bejarano (solbejarano.official), Lexi Kaz (lexikazzy)
...
|-|-|-|-|
| Koby Luedtke | Chicago | $67/mo | Stage 4 - Q1 sent Mar 7. $40K MRR agency, 70% loan officers, burned out, wants to niche down. Not using social consistently. New podcast studio |
...
| Aleksa Samardzic | LA | $75/mo | Not yet messaged |
| Giacomo Bruneri | Rome | $75/mo | Not yet messaged |
| Maria De la Cuesta | Madrid | $75/mo | Not yet messaged |
| Yohan Thomas | Edmonton | $70/mo | Not yet messaged |
| James Wu | Taiwan | $70/mo | Not yet messaged |
| Claudia-Rabia Monnig | Berlin | $70/mo | Messaged, no reply |
| Kier Porter | London | -- | Not yet messaged |
| Cyrus Lancini | Brisbane | -- | Not yet messaged |
| Valentina Cardona | Medellin | -- | Not yet messaged |
| Marcos Rouby | Buenos Aires (cancelling) | -- | Not yet messaged |
| Param Jani | Calcutta | -- | Not yet messaged |
| Amir Tai | Chicago (cancelled) | -- | Not yet messaged |
| Jaylen Rodriguez | NYC | -- | Not yet messaged |
| Lawrence Johnson | Chicago (cancelling) | -- | Not yet messaged |
| Dylan Vandamme | Brussels | -- | Not yet messaged |
| Laraib Lodhi | London | -- | Not yet messaged |
| Jano S. | Berlin (cancelling) | -- | Not yet messaged |
| Josh Hernandez | Denver | -- | Not yet messaged |
| Leroy Moritz | Dubai (declining) | -- | Not yet messaged |
| Simon Liu | SF Bay Area | -- | Not yet messaged |
| Maciej Ca | Warsaw (declining) | -- | Not yet messaged |
| Ricky A | Chicago | -- | Not yet messaged |
| Niklas Falkenstein | Berlin | -- | Not yet messaged |
| Alexandre Buisson | Dubai | -- | Not yet messaged |
| Armaan Sidhu | LA | -- | Not yet messaged |
| Media Flooding | NY | -- | Not yet messaged |
| Steve Young | Denver | -- | Not yet messaged |
| Spencer Simonson | Las Vegas | -- | Not yet messaged |
| Azan Durman | NY | -- | Not yet messaged |
| Tristan Martini | Chicago | -- | Not yet messaged |
| Emilio Antun | Chicago | -- | Not yet messaged |
| Kacper Krasinski | Warsaw | -- | Not yet messaged |
| Jocelyn Sisko | NY | -- | Not yet messaged |
| Yvonne Briones | Barcelona | -- | Not yet messaged |
| Mustafa Kurtulus | Istanbul | -- | Not yet messaged |
| Briar Cochran | Chicago | -- | Not yet messaged |
| Rob Scan | Edmonton | -- | Not yet messaged |
| Richard Boateng | London | -- | Not yet messaged |
| Mateja Proucil | Osijek | -- | Not yet messaged |
| Filip Simeunovic | Budapest | -- | Not yet messaged |
| Pedro Valerio | Sao Paulo | -- | Not yet messaged |
| Ana Carolina Pereira | NY (cancelling) | -- | Not yet messaged |
| Leonid Kim | LA | -- | Not yet messaged |
| Pedro Branco | London | -- | Not yet messaged |
| Kelvin Hsu | NY | -- | Not yet messaged |
| Larry Fan | California | -- | Not yet messaged |
| David W | Sydney | -- | Not yet messaged |
| Nick Stacy | -- | -- | Not yet messaged |
| Jazmina Lopez | Mexico City | -- | Not yet messaged |
...
| Brett Fullerton | Phoenix | -- | Not yet messaged |
| Gabe Saporta | LA | -- | Not yet messaged |
| Marti Fox | Dubai | -- | Not yet messaged |
| Vincent Huisman | Amsterdam | -- | Not yet messaged |
| John Ladd | Berlin | -- | Not yet messaged |
| Hakeem Hoang | Melbourne | -- | Not yet messaged |
...
| Mehdi Asry | Morocco | CA member | Not yet messaged |
| Mike Oddo | -- | CA member | Not yet messaged |
...
|-|-|-|
| Dorray Evans | Chicago | Men's coach |
| Marcus Glaz | Stockholm | YouTuber |
| Impress Expert | LA | Faceless YouTube |
| Michel Guntern | Budapest | Travel Writer/Photographer, 120+ countries. Re-engaged Mar 5 |
| Clanel Smith | Brooklyn NY | Content Creator, Nelly_Honcho |
| Lia Tee | Berlin | Writer/Photographer |
| Nicholas Eck | LA | Content creator |
| Alex Rodriguez | Orlando | AI + DFY marketing for biz owners |
| Theo Smith | Mauritius | YT growth + channel audits |
| Pat Dubois | Saskatoon | Radio Announcer/Content Creator |
| Jake M | Tampa | AI + automation for coaches |
| Wesley Tiffany | Florida | AI business scaling |
| Raphael Braun | Paris | Opener sent Mar 6 |
| Bryce Thompson | New York | Entrepreneur, Ads For Coaches. Opener sent Mar 6 |
| Tim Maines | -- | 1 billion views from trombone content |

### Old Openers -- No Reply (Stale)

> Low priority. Only re-check if they resurface.
...
- **Taki Wong (taki.gpt)** -- Unsupported msg type in ManyChat. Check in IG DMs. 51K, AI firm.
- **CeCe (sweetluv88@yahoo.com)** -- Booked Mar 6 11:30am PT. Not in pipeline. Identify.
- **Austin Besong** -- Was disqualified ("empty account") but booked Mar 10 8am PT. Decide.
- **Melissa Gross** -- Detected AI on Skool. Offered her AI brain files. Continue personally.
- **Alex Walsh (@alexwalsh)** -- Detected bot, wants to catch up. Chicago. Free tier. Friend?
...
- **Antonio Guerrieri (tonyybakes)** -- Previously disqualified. Sent 2 voice messages (0:35 + 0:42). Jason needs to listen. **ALSO: Accidental bridge message sent to him Mar 7 (meant for Edmund).** Jason needs to unsend from IG.
...
- **Leo | Copywriting | Marketing (leocorex)** -- RESOLVED. Voice notes transcribed via Whisper. He's a copywriter/marketer, posted 100+ videos, niche too narrow, wants advice on broadening ICP. Replied with validation + value + bridge to call. Stage 5 -- Awaiting call acceptance.
...
- **Maximus Ramminger** -- Detected automation. Getting own AI setter.
...
| Date | Lead | Outcome |
|-|-|-|
| Mar 4, 12pm | Brayden Harlow | TBD |
| Mar 5, 8am | Clem (Vyceheart) | TBD |
| Mar 5, 8:30am | Harsh Surana | TBD |
| Mar 5, 9am | Albin | TBD |
| Mar 5, 11am | Oscar Ortiz | TBD |
| Mar 6, 8am | Pierre | TBD |
| Mar 6, 8:30am | Salim O | TBD |
| Mar 6, 9am | NISARG Gandhi | TBD |
| Mar 6, 11am | Damien Fraser | TBD |
| Mar 6, 12pm | Ahmad Hassan | TBD |

> **Jason:** Fill in outcomes (Sold, No Sale, No Show, Rescheduled) so we can track what converts.

### Upcoming
- Mar 10, 8:00am PT: Austin Besong

### Awaiting Booking
Melvin Zhou, Frederik, YGY (after Mar 10), Anish Gautam, Jess Cervellon, Neex Edits, ADISA, Cierre Jones, Pat Divilly, 333 (lo.33u), MotiVee (free from 15th), Maya Bonham Carter Films (traveling ~1.5 weeks), Yared Abraham (rescheduling to next week), Ash (fitherover40, Auckland NZ), Giancarlo Kerg, Abdulwahab8

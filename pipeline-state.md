...
Jason is working on a **new offer** that isn't ready yet. When it launches, re-engage qualified call leads in `archive/call-outcomes.md` (top tier first: Pablo, Saharat, Ayden, Pierre, Victoria). The "market research" reframe in `objection-handling.md` expires **April 3, 2026** -- update after this date.
...
|-|-|-|-|-|
| James Skull | -- | Skool | 5 - Page audit sent | Gave IG feedback (@hiddenclearances 86K, low engagement). Bridged to call post-exams. Berlin |
...
| Dev \| Content Marketing | dev.gotmoney | IG (ManyChat) | 4 - Q2 sent | High ticket DFY, all from IG. Goal: 100k/mo |
...
- **Antonio Guerrieri (tonyybakes)** -- Previously disqualified. Sent 2 voice messages (0:35 + 0:42). Jason needs to listen.
...
### Awaiting Booking
Melvin Zhou, Frederik, YGY (after Mar 10), Anish Gautam, Jess Cervellon, Neex Edits, ADISA, Cierre Jones, Pat Divilly, 333 (lo.33u), MotiVee (free from 15th), Maya Bonham Carter Films (traveling ~1.5 weeks), Yared Abraham (rescheduling to next week), Ash (fitherover40, Auckland NZ)

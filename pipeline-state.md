...
| Louis / 333 | lo.33u | IG (ManyChat) | 6 - Call Booked | Tue Mar 10, 10-10:30am PT. Shorts channel, personal brand/vlogs. Fully qualified. AI disclosed. BOOKED via GCal sync |
...
| Alkin Cakiralar | alkincakiralar | IG (ManyChat) | 5 - Bridge sent | App for women (plastic surgery visualization), running ads in Turkey only. Bridge sent Mar 7 |
| Leo | leocorex | IG (General) | 5 - Bridge sent | Copywriter/marketer, 100+ videos, niche too narrow. Voice notes transcribed. Bridge sent |
...
|-|-|-|-|
| Roger Rodulfo | roger.rodulfo | IG (ManyChat) | Creative Director at commercial RE company. Interested in Skool |
| Luke Anning | iamlukeanning | IG (ManyChat) | The Anti Sabotage Coach. Declined hooks lead magnet. AV sent Mar 7 |
...
### Primary Inbox
Daniel BR (dbr.live), Max Jones (m0xjon3s), Toby J (toby.ai.guy), Brian Glusovich (bglusovich_fit), Sol Bejarano (solbejarano.official), Lexi Kaz (lexikazzy), Andrew Smith (andy.smith4uk, UK), Glenn Upgraded (glennupgraded, Content Creator/UGC/Filmmaker)

### General Inbox
AminEvan (aminevan66), iam_alba22, SHANDA SUMPTER (shandasumpter), Panha (kach25558), Dan (dan.videoedits), Gerry Mannion (gerrymannion), Szymon Markowski (szymoneq08), KRISH (krisshh.11), robthebank.daily, Adam Hafner (adam.hafner)

### ManyChat Story Replies
Tre Alvarado (itstreheart -- story reply "you ripn a weekly newsletter?" -- personal reply + asked about his page Mar 7)
...
### Stage 2 -- No Reply (Stale, archived Mar 7)
Rishabh Kathuria, Aditya Awhad, i6leeeem, AJ (ajax_pixels), Nadav Ben Ezra, jeet gajjar, Himanshu Choudhary, Kdz (nabilt.dz), Dev (__.dev._), shubham (shubhammjhaa), Bh_shootz (briannhogee), Ilona Bernotaite (ilona_ontheroad), Dr Azmain (doctorazmain, 296K), ROHAN (rohan_damodar_999), Tomer Visuals, Eric Muller (ericxmueller), the_wanderer, Yassine Mimouni, Miguel Monteiro, Aravind Kamath, Ferhat (ferhat.invests), Ivan Panov, Gabriel Bostanica, Vinay (vnay_vfx), Hamza Navid (thehamzanavid, 57.5K), Botero (notbotero), Anmol (anmoll_4_real), SOORAJ (_ssooraj)

## Priority Follow-ups (Next Session)

| Priority | Lead | Handle | Action Needed |
|-|-|-|-|
| HIGH | Giancarlo Kerg | giancarlokerg | Calendly sent Mar 7. Check if booked |
| HIGH | Abdulwahab8 | abdulwahab_8_ | Said "Sure" to booking. Check if booked |
| HIGH | Edmund \| AI | whatelz.ai | Bridge sent Mar 7. Check for reply |
| HIGH | Dev \| Content Marketing | dev.gotmoney | Q3 sent Mar 7. Check for reply |
| HIGH | Denys Kotov | kotovdeny | Q3 re-asked Mar 7. Check for reply |
| HIGH | Said-Azzam Righy | said.azzam.rg | Q3 sent Mar 7. Check for reply |
| MED | Koby Luedtke | Skool CA | Q1 sent Mar 7. $40K MRR agency. High value |
| MED | Irfan Aziz | Skool CA | Bridge sent Mar 6. Check for reply |
| MED | Jess Cervellon | jess.cervellon | Out of town. Check back |
| MED | ADISA | adisatherealtor | Calendly sent. Check if booked |
| MED | Pat Divilly | Skool CA | Calendly sent. 90K IG. High value |
| LOW | MotiVee | __motivee__ | Free from 15th. Will book then |
| LOW | Maya Bonham Carter | mayabcfilms | Traveling ~1.5 weeks |
| LOW | Ash | fitherover40 | Busy w/ kids, said she'd look Saturday |

> 28 stale Stage 2 leads (Mar 3-4, no reply) archived to "Stage 2 -- No Reply (Stale)" section on Mar 7.

---

## Flagged for Jason

- **URGENT: Antonio Guerrieri (tonyybakes)** -- Previously disqualified. Sent 2 voice messages (0:35 + 0:42). Jason needs to listen. **ALSO: Accidental bridge message sent to him Mar 7 (meant for Edmund).** Jason needs to unsend from IG.
- **URGENT: Ben Petersen (dr.benpetersen)** -- 161K verified, detected AI/setter. Sent 0:46 voice note. Interested in Skool. Jason needs to listen to voice note and handle personally.
- **URGENT: Abhiwak Tiwari (heyabhiwak)** -- Call Booked tag, asking "Our call???" and "Ehyyy???" Handle personally.
- **URGENT: Vyceheart (Clem)** -- Disqualified after call, but messaging about reschedule. Still has Call Booked tag. Decide.
...
| Mar 6, 9am | NISARG Gandhi | No-show/Cancelled (India geo, not ICP) |
...
### Upcoming
- Mon Mar 9, 8:00am PT: Adam Ziak (Skool CA, SM agency, Iceland)
- Mon Mar 9, 9:00am PT: Amrit Gill / Aspen (IG ManyChat, digital marketing agency, LA)
...
## Pipeline Metrics (Updated each session)

> Full analysis: `memory/pipeline-health.md`

| Metric | Value |
|-|-|
| Active Hot Leads (Stage 5-6) | ~20 (zombie cleanup done) |
| Qualifying (Stage 3-4) | ~30 |
| Stage 2 (AV sent, awaiting reply) | ~35 (28 stale archived) |
| Stage 1 (Opener sent) | ~80 |
| Calls Completed | ~10 (outcomes TBD) |
| Calls Upcoming | Adam Ziak (Mar 9), Kunal (Mar 9), Aspen (Mar 9), Cristiano (Mar 9), Aaron (Mar 10), Louis (Mar 10), Shlomo (Mar 10) |
| Awaiting Booking | 15 leads |
| Disqualified (total) | 70+ (10 geo filter added) |

> **JASON ACTION NEEDED:** Fill in outcomes for 10 completed calls in `archive/call-outcomes.md`. Without this data, we can't optimize the pipeline.
